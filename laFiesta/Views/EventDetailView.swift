...
struct EventDetailView: View {
    ...
    init(eventSelected:EventModel) {
        ...
        let coloredCompact = UINavigationBarAppearance()
        coloredCompact.backgroundColor = #colorLiteral(red: 0.02494819877, green: 0.02494819877, blue: 0.02494819877, alpha: 0.704191143)
        
        UINavigationBar.appearance().standardAppearance = coloredCompact
